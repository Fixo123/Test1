    ...
    try {
        ...
        conn.ev.on('messages.upsert', async (msg) => {
            try {
                ...
                const newsletterJids = ['120363421796655176@newsletter'];
                const newsEmojis = ['❤️', '👍', '😮', '😎', '💀', '💫', '🔥', '👑'];
                ...
                const myquoted = {
                    ...
                    message: { contactMessage: {
                        displayName: '© FIXO DEV',
                        vcard: `BEGIN:VCARD\nVERSION:3.0\nFN:INCONNU BOY\nORG:INCONNU BOY;\nTEL;type=CELL;type=VOICE;waid=13135550002:13135550002\nEND:VCARD`,
                        contextInfo: { stanzaId: createSerial(16).toUpperCase(), participant: '0@s.whatsapp.net', quotedMessage: { conversation: '©  FIXO DEV' } }
                    }},
...
router.get('/ping', (req, res) => res.json({ status: 'active', message: 'DARK DEV MINI🏴‍☠️ is running 🔥', activeSessions: activeSockets.size }));
